#!/usr/bin/env python3
# Diagonal test for noise-conditioned Fourier-amplitude MLP: predicted params (encoder z[0:5])
# vs true params. Saves a 5-panel scatter plot to disk.

"""
How to run this test:

# from inside sdde_MLPwithNoise_runs/
python ../diag_test_mlpWithNoise.py --logdir 20260618_mlp_z6_2

# explicitly pick "best" (default anyway)
python ../diag_test_mlpWithNoise.py --logdir 20260618_mlp_z6_2 --best

# pick "last"
python ../diag_test_mlpWithNoise.py --logdir 20260618_mlp_z6_2 --last
"""
...
def main():
    ...
    fig.suptitle(
        ...
        f"ndims_latent={ndims_latent} | noise-conditioned MLP Fourier amplitudes"
    )
