#!/usr/bin/env python3
# Diagonal test for time-domain ENCA: predicted params (encoder z[0:5]) vs true params
...
python ../diag_test_enca.py --logdir 20260305_142921_test

# explicitly pick "best" (default anyway)
python ../diag_test_enca.py --logdir 20260305_142921_test --best

# pick "last"
python ../diag_test_enca.py --logdir 20260305_142921_test --last
"""
...
def build_encoder_decoder(
    ...
    """
    Rebuilds the same time-domain ENCA architecture as the training script.
    ...
    # Decoder is needed for checkpoint object structure, even though this test
    # only uses the encoder.
...
def main():
    ...
    if representation_mode != "time":
        raise ValueError(
            f"diag_test_enca.py expects representation_mode='time', got {representation_mode!r}. "
            "Use diag_test_mlp.py for Fourier-amplitude MLP runs."
        )
    ...
    fig.suptitle(
        ...
        f"ndims_latent={ndims_latent} | ENCA time-domain"
    )
